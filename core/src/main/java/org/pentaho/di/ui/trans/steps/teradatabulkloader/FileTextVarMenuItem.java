...
public class FileTextVarMenuItem extends TextVarMenuItem {
  private final Shell shell;

  FileTextVarMenuItem( Shell shell, Composite parent, PropsUI props, TransMeta transMeta, ModifyListener lsMod,
      Control top, String labelProp ) {
    super( parent, props, transMeta, lsMod, top, labelProp, TeraDataBulkLoaderDialog.FILE_BUTTON );
    this.shell = shell;
  }
  ...
  protected SelectionListener createSelectionListener( TextVar textVar ) {
    return new FileSelectionButtonListener( textVar, shell );
  }
}
