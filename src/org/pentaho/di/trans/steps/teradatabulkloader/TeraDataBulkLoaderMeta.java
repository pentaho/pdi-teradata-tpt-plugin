...
public class TeraDataBulkLoaderMeta extends BaseStepMeta implements StepMetaInterface, ProvidesDatabaseConnectionInformation
{
    ...
    public TeraDataBulkLoader getStep()               		{    	return this.myStep;    }
    public Boolean setGenerateScript(Boolean val)         	{    	return this.generateScript = val;    }
    public Boolean getGenerateScript()                    	{    	return this.generateScript;    }
    public Boolean setSubstituteControlFile(Boolean val)  	{    	return this.substituteScriptFile = val;    }
    public Boolean getSubstituteControlFile()             	{    	return this.substituteScriptFile;    }
    public String  setExistingScriptFile(String val)        {    	return this.existingScriptFile = val;    }
    public String  getExistingScriptFile()                  {    	return this.existingScriptFile;    }
    public String  setJobName(String val)        			{    	return this.jobName = val;    }
    public String  getJobName()                  			{    	return this.jobName;    }
    public String  getVariableFile() 						{    	return this.existingVariableFile;    }
    public String  setVariableFile(String val)				{    	return this.existingVariableFile = val;    }
    public Boolean getDropLogTable() 						{    	return this.dropLogTable;    }
    public Boolean setDropLogTable(Boolean val)				{    	return this.dropLogTable = val;    }
    public Boolean getDropWorkTable() 						{    	return this.dropWorkTable;    }
    public Boolean setDropWorkTable(Boolean val)			{    	return this.dropWorkTable = val;    }
    public Boolean getDropErrorTable()		 				{    	return this.dropErrorTable;    }
    public Boolean setDropErrorTable(Boolean val)			{    	return this.dropErrorTable = val;    }
    public Boolean getDropErrorTable2()						{    	return this.dropErrorTable2;    }
    public Boolean setDropErrorTable2(Boolean val)			{    	return this.dropErrorTable2 = val;    }
    public Boolean getIgnoreDupUpdate() 					{    	return this.ignoreDupUpdate;    }
    public Boolean setIgnoreDupUpdate(Boolean val)			{    	return this.ignoreDupUpdate = val;    }
    public Boolean getInsertMissingUpdate() 				{    	return this.insertMissingUpdate;    }
    public Boolean setInsertMissingUpdate(Boolean val)		{    	return this.insertMissingUpdate = val;    }
    public Boolean getIgnoreMissingUpdate() 				{    	return this.ignoreMissingUpdate;    }
    public Boolean setIgnoreMissingUpdate(Boolean val)		{    	return this.ignoreMissingUpdate = val;    }
    public Boolean getSubstituteVariableFile() 				{    	return this.substituteVariableFile;    }
    public Boolean setSubstituteVariableFile(Boolean val)	{    	return this.substituteVariableFile = val;    }
    public String  setTbuildPath(String val)				{    	return this.tbuildPath = val;    }
    
    public String  getTdInstallPath() 						{ 		return this.installPath; }
    public String  getTbuildPath()							{    	return Const.isEmpty(this.tbuildPath) 	 ? getTwbRoot() + "/bin/tbuild" : this.tbuildPath;    }
    public String  getTbuildLibPath() 						{ 		return Const.isEmpty(this.tbuildLibPath) ? getTwbRoot() + "/lib" : this.tbuildLibPath; }
    public String  getLibPath()								{ 		return Const.isEmpty(this.libPath) 		 ? installPath + "/lib" : this.libPath; }
    public String  getCopLibPath() 							{ 		return Const.isEmpty(this.copLibPath) 	 ? installPath + "/lib" : this.copLibPath; }
    public String  getTdicuLibPath() 						{ 		return Const.isEmpty(this.tdicuLibPath)  ? installPath + "/tdicu/lib" : this.tdicuLibPath; }
    public String  getTwbRoot() 							{ 		return Const.isEmpty(this.twbRoot) 		 ? installPath + "/tbuild" : this.twbRoot; }
    
    public String  setTbuildLibPath(String s) 				{ 		return this.tbuildLibPath = s; }
    public String  setLibPath(String s) 					{ 		return this.libPath = s; }
    public String  setCopLibPath(String s) 					{ 		return this.copLibPath = s; }
    public String  setTdicuLibPath(String s) 				{ 		return this.tdicuLibPath = s; }
    public String  setTdInstallPath(String s) 				{ 		return this.installPath = s; }
    public String  setTwbRoot(String s) 					{ 		return twbRoot = s; }
    public String  setFifoFileName(String val)				{    	return this.fifoFileName = val;    }
    public String  getFifoFileName()						{    	return this.fifoFileName;    }
    public String  setScriptFileName(String val)			{    	return this.scriptFileName = val;    }
    public String  getScriptFileName()						{    	return this.scriptFileName;    }
    public String  getDbName()								{    	return this.databaseMeta.getDatabaseInterface().getDatabaseName();    }
    public String  getSchemaName() 							{    	return this.schemaName;    }
    public String  setSchemaName(String val) 				{    	return this.schemaName = val;    }
    public String  getLogTable() 							{    	return this.logTable;    }
    public String  setLogTable(String val) 					{    	return this.logTable = val;    }
    public String  getWorkTable() 							{    	return this.workTable;    }
    public String  setWorkTable(String val) 				{    	return this.workTable = val;    }
    public String  getErrorTable() 							{    	return this.errorTable;    }
    public String  setErrorTable(String val) 				{    	return this.errorTable = val;    }
    public String  getErrorTable2() 						{    	return this.errorTable2;    }
    public String  setErrorTable2(String val) 				{    	return this.errorTable2 = val;    }
    public String  getAccessLogFile() 						{    	return this.accessLogFile;    }
    public String  setAccessLogFile(String val) 			{    	return this.accessLogFile = val;    }
    public String  getUpdateLogFile() 						{    	return this.updateLogFile;    }
    public String  setUpdateLogFile(String val) 			{    	return this.updateLogFile = val;    }
    public int     getActionType() 							{    	return this.actionType;    }
    public int     setActionType(int val) 					{    	return this.actionType = val;    }
 
    public void     setDatabaseMeta(DatabaseMeta database)  {       this.databaseMeta = database;    }
    public String   getTableName()    						{       return tableName;    }
    public void     setTableName(String tableName)    		{       this.tableName = tableName;    }
    public String[] getFieldTable()    						{       return fieldTable;    }
    public void     setFieldTable(String[] fieldTable)    	{       this.fieldTable = fieldTable;    }
    public String[] getFieldStream()    					{       return fieldStream;    }
    public void     setFieldStream(String[] fieldStream)    {       this.fieldStream = fieldStream;    }
    public Boolean[] getFieldUpdate()    					{       return fieldUpdate;    }
    public void     setFieldUpdate(Boolean[] fieldUpdate)    {       this.fieldUpdate = fieldUpdate;    }

    public String[] getKeyStream()    					    {       return keyStream;    }
    public void     setKeyStream(String[] fieldStream)      {       this.keyStream = fieldStream;    }
    public String[] getKeyLookup()    					    {       return keyLookup;    }
    public void     setKeyLookup(String[] fieldStream)      {       this.keyLookup = fieldStream;    }
    public String[] getKeyCondition()    					{       return keyCondition;    }
    public void     setKeyCondition(String[] fieldStream)   {       this.keyCondition = fieldStream;    }

    
	@Override
	public void loadXML(Node stepnode, List<DatabaseMeta> databases, Map<String, Counter> arg2) throws KettleXMLException {
		...
		throws KettleXMLException
	{
		try
		{
			...
			if (sactionType != null) actionType = Integer.parseInt(sactionType);
			...
			throw new KettleXMLException(BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.Exception.UnableToReadStepInfoFromXML"), e); 
		}
	}
	...
	@Override
	public void readRep(Repository rep, ObjectId id_step, List<DatabaseMeta> databases, Map<String, Counter> arg3) throws KettleException {
		...
		{
			throw new KettleException(BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.Exception.UnexpectedErrorReadingStepInfoFromRepository"), e); 
		}
	}
	...
	@Override
	public void saveRep(Repository rep, ObjectId id_transformation, ObjectId id_step) throws KettleException {                   // 4.x compatibility
		...
		{
			throw new KettleException(BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.Exception.UnableToSaveStepInfoToRepository")+id_step, e); 
		}
	}
	...
	public void check(List<CheckResultInterface> remarks, TransMeta transMeta, StepMeta stepMeta, RowMetaInterface prev, String input[], String output[], RowMetaInterface arg6) {
		...
		if (databaseMeta!=null)
		{
			...
			try
			{
				...
				{
					cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.TableNameOK"), stepMeta); 
					remarks.add(cr);
					...
					if (r!=null)
					{
						cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.TableExists"), stepMeta); 
						remarks.add(cr);
						...
						for (int i=0;i<fieldTable.length;i++)
						{
							...
							if (v==null)
							{
								...
								{
									first=false;
									error_message+=BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.MissingFieldsToLoadInTargetTable")+Const.CR; 
								}
								error_found=true;
						...
						{
							cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.AllFieldsFoundInTargetTable"), stepMeta); 
						}
						remarks.add(cr);
					}
					else
				...
				{
					cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.StepReceivingDatas",prev.size()+""), stepMeta);  
					remarks.add(cr);
					...
					for (int i=0;i<fieldStream.length;i++)
					{
						...
						if (v==null)
						{
							...
							{
								first=false;
								error_message+=BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.MissingFieldsInInput")+Const.CR; 
							}
							error_found=true;
					...
					{
						cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.AllFieldsFoundInInput"), stepMeta); 
					}
					remarks.add(cr);
				}
				else
				{
					error_message=BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.MissingFieldsInInput3")+Const.CR; 
					cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepMeta);
					remarks.add(cr);
				}
			}
			...
			{
				error_message = BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.DatabaseErrorOccurred")+e.getMessage(); 
				cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, error_message, stepMeta);
				remarks.add(cr);
			}
			finally
		...
		if (input.length>0)
		{
			cr = new CheckResult(CheckResultInterface.TYPE_RESULT_OK, BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.StepReceivingInfoFromOtherSteps"), stepMeta); 
			remarks.add(cr);
		}
		else
		{
			cr = new CheckResult(CheckResultInterface.TYPE_RESULT_ERROR, BaseMessages.getString(PKG, "TeraDataBulkLoaderMeta.CheckResult.NoInputError"), stepMeta); 
			remarks.add(cr);
		}
	}
	...
	public void analyseImpact(List<DatabaseImpact> impact, TransMeta transMeta, StepMeta stepMeta, 
			RowMetaInterface prev, String input[], String output[], RowMetaInterface info, Repository repository, IMetaStore metaStore) throws KettleStepException
    {
        if (prev != null)
        {
